...
_CLASS_NAME = {
    ...
    "ActivityNet": ['Applying sunscreen', 'Archery', 'Arm wrestling', 'Assembling bicycle',
                    ...
                    'Drinking beer', 'Drinking coffee', 'Drum corps', 'Elliptical trainer', 'Fixing bicycle',
                    'Fixing the roof',
                    'Fun sliding down', 'Futsal', 'Gargling mouthwash', 'Getting a haircut', 'Getting a piercing',
                    'Getting a tattoo',
                    'Grooming dog', 'Grooming horse', 'Hammer throw', 'Hand car wash', 'Hand washing clothes',
                    'Hanging wallpaper',
                    'Having an ice cream', 'High jump', 'Hitting a pinata', 'Hopscotch', 'Horseback riding',
                    'Hula hoop',
                    ...
                    'Peeling potatoes', 'Ping-pong', 'Plastering', 'Plataform diving', 'Playing accordion',
                    'Playing badminton',
                    'Playing bagpipes', 'Playing beach volleyball', 'Playing blackjack', 'Playing congas',
                    'Playing drums',
                    'Playing field hockey', 'Playing flauta', 'Playing guitarra', 'Playing harmonica',
                    'Playing ice hockey',
                    ...
                    'Playing water polo', 'Pole vault', 'Polishing forniture', 'Polishing shoes', 'Powerbocking',
                    'Preparing pasta',
                    ...
                    'Using parallel bars',
                    'Using the balance beam', 'Using the monkey bar', 'Using the pommel horse',
                    'Using the rowing machine',
                    'Using uneven bars', 'Vacuuming floor', 'Volleyball', 'Wakeboarding', 'Walking the dog',
                    'Washing dishes',
                    'Washing face', 'Washing hands', 'Waterskiing', 'Waxing skis', 'Welding', 'Windsurfing',
                    'Wrapping presents',
                    'Zumba']
}
...
def build_args(dataset=None):
    ...
    parser.add_argument("--start_test_epoch", default=0, type=int)

    parser.add_argument("--loss_lamb_lcs", default=0.1, type=float)
    parser.add_argument("--loss_lamb_fsd", default=0.8, type=float)

    parser.add_argument("--thres", default=0.92, type=float)
    parser.add_argument("--lcs_len", default=30, type=int)
    parser.add_argument("--fsd_len", default=5, type=int)
